...
import jbok.core.configs.{MiningConfig, Timeouts}
...
trait BlockGeneratorFixture extends LedgerFixture {
  val testAddress = 42
  val privateKey =
    KeyPair.Secret(new BigInteger(1, hex"f3202185c84325302d43887e90a2e23e7bc058d0450bb58ef2f7585765d7d48b".toArray))
  val pubKey  = SecP256k1.generatePublicKey(privateKey).unsafeRunSync()

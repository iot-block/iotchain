...
/**
  ...
  *  - `ExecutedBlock` block with executed world state, gasUsed, receipts
...
object TypedBlock {
  final case class ExecutedBlock[F[_]](block: Block, world: WorldState[F], gasUsed: N, receipts: List[Receipt]) extends TypedBlock
